...
//   We don't want to install DX9 SDK, so i don't include d3dx9.h and replace it with "MissingDX9Stuffs.h".
//   We don't use Oculus SDK or all occulus stuffs are removed.
...
// Quick replacment for d3dx9.h
#include "MissingDX9Stuffs.h"

class Direct3DDevice9Hooks : public IDirect3DDevice9
{
public:
	Direct3DDevice9Hooks(IDirect3D9* parent, IDirect3DDevice9* inner, const D3DPRESENT_PARAMETERS& present_parameters);
...
private:
	...
	void SetViewProjection(D3DXMATRIX &transforms);
};
